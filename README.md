...
Fractional trimming assigns partial weight to the boundary observation(s) when the trimming proportion falls between discrete jumps of the empirical distribution, most notably in the presence of ties at the trimming cutoff.
