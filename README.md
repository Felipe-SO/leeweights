...
As in Semenova (2025), the direction of monotonicity is allowed to vary across the covariate space. Unlike Semenova's full approach, however, this command only allows for a discrete partition of the covariate space. As a result, the procedure does not rely on regularization methods or orthogonalization corrections.
